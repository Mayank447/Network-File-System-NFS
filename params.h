...
#define NO_CLIENTS_TO_LISTEN_TO 100 // Maximum no. of clients the name server can handle
#define NO_SERVER_TO_LISTEN_TO 50 // Maximum no. of storage servers can initialize
